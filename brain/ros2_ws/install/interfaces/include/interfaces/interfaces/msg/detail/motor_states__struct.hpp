...
#ifndef INTERFACES__MSG__DETAIL__MOTOR_STATES__STRUCT_HPP_
#define INTERFACES__MSG__DETAIL__MOTOR_STATES__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__interfaces__msg__MotorStates __attribute__((deprecated))
#else
# define DEPRECATED__interfaces__msg__MotorStates __declspec(deprecated)
#endif
...
struct MotorStates_
{
  ...
  // pointer types
  using RawPtr =
    interfaces::msg::MotorStates_<ContainerAllocator> *;
  using ConstRawPtr =
    const interfaces::msg::MotorStates_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<interfaces::msg::MotorStates_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<interfaces::msg::MotorStates_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      interfaces::msg::MotorStates_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::MotorStates_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<interfaces::msg::MotorStates_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<interfaces::msg::MotorStates_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<interfaces::msg::MotorStates_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__interfaces__msg__MotorStates
    std::shared_ptr<interfaces::msg::MotorStates_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__interfaces__msg__MotorStates
    std::shared_ptr<interfaces::msg::MotorStates_<ContainerAllocator> const>
...
using MotorStates =
  interfaces::msg::MotorStates_<std::allocator<void>>;
...
#endif  // INTERFACES__MSG__DETAIL__MOTOR_STATES__STRUCT_HPP_
