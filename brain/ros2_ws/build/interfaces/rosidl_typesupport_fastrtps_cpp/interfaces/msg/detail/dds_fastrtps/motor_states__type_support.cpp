...
#include "interfaces/msg/detail/motor_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::MotorStates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::MotorStates & ros_message)
{
  // Member: left_front
  cdr >> ros_message.left_front;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::MotorStates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::MotorStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::MotorStates *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotorStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, MotorStates)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotorStates__handle;
}
